...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "WolfClover";
        CTransaction txNew;
        txNew.nTime = 1524280831;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1524280831;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 412293 : 412293;
        ...
        assert(block.hashMerkleRoot == uint256("0x9afe34064bb85438f41f91d3c070797abc2892bd63c2dc84e81c8d0954d846e2"));
