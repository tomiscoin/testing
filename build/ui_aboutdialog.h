...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CloverCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>CloverCoin</b> version", 0));
...
"Copyright \302\251 2018 The CloverCoin developers", 0));
